  ...
  if phut%2==0:
    if stop==0:
      ...
      if tinh%2==0:
        cau='Even'
        cl='Chẵn'
        requests.get('https://api.telegram.org/bot7407325672:AAEEBeXZkgwwA57qDyYdgrt6OcoZY6VfEZY/sendMessage?chat_id=-4269359270&text=Mọi người! Hãy Đánh 𝘾𝙝ẵ𝙣')
      else:
        cau='Odd'
        cl='Lẻ'
        requests.get('https://api.telegram.org/bot7407325672:AAEEBeXZkgwwA57qDyYdgrt6OcoZY6VfEZY/sendMessage?chat_id=-4269359270&text=Mọi người! Hãy Đánh 𝙇ẻ')
      ...
      if checkk!=landau:
        if kiemtra in result[0]:
          ...
          if ccc=='cc':
            ccc=''
          requests.get('https://api.telegram.org/bot7407325672:AAEEBeXZkgwwA57qDyYdgrt6OcoZY6VfEZY/sendMessage?chat_id=-4269359270&text=🏆Kết quả: Thắng ✅')
          ...
          if ccc=='cc':
            ccc=''
          requests.get('https://api.telegram.org/bot7407325672:AAEEBeXZkgwwA57qDyYdgrt6OcoZY6VfEZY/sendMessage?chat_id=-4269359270&text=🏆Kết quả: Thua ⛔')
          requests.get('https://api.telegram.org/bot7407325672:AAEEBeXZkgwwA57qDyYdgrt6OcoZY6VfEZY/sendMessage?chat_id=-4269359270&text='+'🟢 Thắng: '+str(win)+'\n🔴 Thua: '+str(lose))
      kiemtra=cau
      print('\n')
      checkk=check
